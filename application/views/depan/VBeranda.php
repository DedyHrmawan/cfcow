            ...
            <div class="card-body py-3">
                <div class="card card-xl-stretch mb-xl-8">
                    <div class="row g-5 g-xl-8 mt-0">
                        <div class="col-xl-3">
                            <span href="#" class="card bg-light hoverable card-xl-stretch mb-xl-8">
                                <div class="card-body">
                                    ...
                                    <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5"><?= $gejala ?></div>
                                    <div class="fw-bold text-gray-400">Total Gejala</div>
                                </div>
                            </span>
                        </div>
                        <div class="col-xl-3">
                            <span href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                                <div class="card-body">
                                    ...
                                    <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5"><?= $penyakit ?></div>
                                    <div class="fw-bold text-gray-100">Total Penyakit</div>
                                </div>
                            </span>
                        </div>
                        <div class="col-xl-3">
                            <span href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                                <div class="card-body">
                                    ...
                                    <div class="text-white fw-bolder fs-2 mb-2 mt-5"><?= $pengetahuan ?></div>
                                    <div class="fw-bold text-white">Total Pengetahuan</div>
                                </div>
                            </span>
                        </div>
                        <div class="col-xl-3">
                            <span href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                                <div class="card-body">
                                    <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <div class="fw-bold text-white">Total Admin Pakar</div>
                                </div>
                            </span>
                        </div>
                    </div>
