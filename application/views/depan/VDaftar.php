        ...
        <div class=" mb-5 mt-n10">
            <div class=" py-3">
                ...
                <div class="w-lg-600px bg-body rounded shadow-sm p-10 mx-auto">
                    <form class="form w-100" action="<?= site_url('') ?>" method="post">
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <input class="form-control form-control-lg form-control-solid" type="number" name="" placeholder="Masukan Nomor Handphone" autocomplete="off" required />
                        </div>
                        <div class="fv-row mb-10">
                            <label class="form-label fs-6 required fw-bolder text-dark">Pesan</label>
                            <textarea class="form-control form-control-lg form-control-solid" type="text" name="" placeholder="Masukan Pesan" autocomplete="off" required cols="10" rows="5"></textarea>
                        </div>
                        <div class="fv-row mb-10">
