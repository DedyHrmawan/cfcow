...
<head>
    ...
    <title><?= $title ?></title>
    <meta charset="utf-8" />
    <meta name="CF COW" content="Sistem Pakar Sapi" />
    <meta name="keywords" content="CF, pakar, sapi" />
...
<body id="kt_body" <?= $this->uri->segment(1) == 'blank' ? 'data-kt-aside-minimize="on"' : '' ?> href="<?php echo site_url('blank'); ?>" <?= $this->uri->segment(1) == 'bantuan' ? 'data-kt-aside-minimize="on"' : '' ?> href="<?php echo site_url('bantuan'); ?>" <?= $this->uri->segment(1) == 'daftaruser' ? 'data-kt-aside-minimize="on"' : '' ?> href="<?php echo site_url('daftaruser'); ?>" <?= $this->uri->segment(1) == '' ? 'data-kt-aside-minimize="on"' : '' ?> href="<?php echo site_url(''); ?>" <?= $this->uri->segment(1) == 'login' ? 'data-kt-aside-minimize="on"' : '' ?> href="<?php echo site_url('login'); ?>" <?= $this->uri->segment(1) == 'daftar' ? 'data-kt-aside-minimize="on"' : '' ?> href="<?php echo site_url('daftar'); ?>" class=" header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
