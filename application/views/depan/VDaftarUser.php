        ...
        <div class=" mb-5 mt-n10">
            <div class=" py-3">
                ...
                <div class="w-lg-600px bg-body rounded shadow-sm p-10 mx-auto">
                    <form class="form w-100" action="<?= site_url('') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <input class="form-control form-control-lg form-control-solid" type="text" name="" placeholder="Masukan Username" autocomplete="off" required />
                        </div>
                        <div class="fv-row mb-10">
                            <div class="d-flex flex-stack mb-2">
                                <label class="form-label required fw-bolder text-dark fs-6 mb-0">Password</label>
                            </div>
                            <input class="form-control form-control-lg form-control-solid" type="password" name="" placeholder="Masukan Password" autocomplete="off" required />
                        </div>
                        <div class="fv-row mb-10">
                            <label class="form-label fs-6 required fw-bolder text-dark">Nama Lengkap</label>
                            <input class="form-control form-control-lg form-control-solid" type="text" name="" placeholder="Masukan Nama Lengkap" autocomplete="off" required />
                        </div>
                        <div class="fv-row mb-10">
                            <label class="form-label fs-6 required fw-bolder text-dark">Email</label>
                            <input class="form-control form-control-lg form-control-solid" type="email" name="" placeholder="Masukan Email" autocomplete="off" required />
                        </div>
                        <div class="fv-row mb-10">
                            <label class="form-label fs-6 required fw-bolder text-dark">Lokasi Peternakan</label>
                            <input class="form-control form-control-lg form-control-solid" type="text" name="telepon" placeholder="Masukan Lokasi Peternakan" autocomplete="off" required />
                        </div>
