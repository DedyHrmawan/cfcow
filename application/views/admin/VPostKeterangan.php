                    ...
                    <table class="table table-rounded table-row-bordered table-row-gray-300 align-middle gs-0 gy-3" id="tabelPostingan">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-dark fw-bolder text-hover-primary fs-6">
                                    Pullorum Disease disebut juga Bacillary White Diarrhea dan yang lebih popular disebut Postingan berak kapur atau berak putih.
                                </td>
                                <td class="text-dark fw-bolder text-hover-primary fs-6">
                                ...
                                <td class="">
                                    <a href="" title="Detail Postingan" data-bs-toggle="modal" data-bs-target="#mdl_detailPostingan" data-id="" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm mdl_detailPostingan me-1">
                                    ...
                                    <a href="" title="Edit Postingan" data-bs-toggle="modal" data-bs-target="#mdl_editPostingan" data-id="" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm mdl_editPostingan m-1">
                                    ...
                                    <a href="#" title="Hapus Postingan" data-bs-toggle="modal" data-bs-target="#mdl_delPostingan" data-id="" class="btn btn-icon btn-bg-light btn-active-color-primary mdl_delPostingan btn-sm m-1">
                                        <span class="svg-icon svg-icon-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <div class="modal-body">
                <form action="<?= site_url('') ?>" method="post">
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input type="text" class="form-control form-control-solid" placeholder="Masukan Nama Postingan" name="" required />
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">Detail Postingan</span>
                        </label>
                        <textarea class="form-control form-control-solid tox-target textTiny" placeholder="Masukan Detail Postingan" name="" cols="30" rows="10" required></textarea>
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">Saran Postingan</span>
                        </label>
                        <textarea class="form-control form-control-solid tox-target textTiny" placeholder="Masukan Saran Postingan" name="" cols="30" rows="10" required></textarea>
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row">
